...
export class Wallet {
  ...
  credit(amount: Money): Wallet {
    ...
    return new Wallet(this.id, this.accountId, this.currency, this.balance.add(amount), this.status, this.createdAt)
  }
  ...
  debit(amount: Money): Wallet {
    ...
    return new Wallet(this.id, this.accountId, this.currency, this.balance.subtract(amount), this.status, this.createdAt)
  }
