import { buildRemittanceModule, buildSearchRemittancesModule } from "src/main/remittance/remittance-module";
...
export function createSearchRemittancesUseCase(): UseCase<SearchRemittancesInput, SearchRemittancesOutput> {
